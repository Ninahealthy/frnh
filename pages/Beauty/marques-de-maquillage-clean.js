...
export default function Home() {
  return (
    <>
      <Head>
        <title>
          Beauté naturelle: 4 marques de maquillage propres à shopper
        </title>

        <meta
          name="description"
          content="Découvrez 4 marques de maquillage propres et éthiques qui vont sublimer votre beauté naturelle sans compromettre la qualité ou la sécurité. Des produits innovants et respectueux de la peau et de l’environnement à essayer absolument!"
        />
      </Head>
      <AuthorIcon />
      <article>
